  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-28 right-1/2 z-30 flex h-14 w-14 translate-x-[calc(min(50vw,224px)-1.5rem)] items-center justify-center rounded-full bg-primary text-primary-foreground shadow-lg shadow-primary/30 transition-transform active:scale-90"
      >
