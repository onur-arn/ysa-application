...
export const GROUP_CHATS: GroupConversation[] = [
  ...
  },
  {
    id: "nancy",
    type: "group",
    lastMessage: "Chloé: Turnuva yaklaşıyor!",
    lastTime: "Pzt",
    unread: 0,
    messages: [{ id: "1", author: "Chloé Petit", initials: "CP", text: "Turnuva yaklaşıyor!", time: "11:00" }],
  },
  {
    id: "strasbourg",
    type: "group",
    lastMessage: "Léa: Gece menüsü onaylandı",
    lastTime: "Paz",
    unread: 0,
    messages: [{ id: "1", author: "Léa Martin", initials: "LM", text: "Gece menüsü onaylandı", time: "20:12" }],
  },
  {
    id: "caen",
    type: "group",
    lastMessage: "Mehmet: Tüm gönüllülere teşekkürler",
    lastTime: "Cmt",
    unread: 0,
    messages: [{ id: "1", author: "Mehmet Yılmaz", initials: "MY", text: "Tüm gönüllülere teşekkürler", time: "16:45" }],
  },
  {
    id: "hamburg",
    type: "group",
    lastMessage: "Jana: Kampanya özeti",
    lastTime: "Cum",
    unread: 0,
    messages: [{ id: "1", author: "Jana Müller", initials: "JM", text: "Kampanya özeti", time: "09:00" }],
  },
]
